...
rmc-job-greeting-para =
    You are a member of the RCM's 24th Paramarine Regiment!
...
rmc-job-greeting-riot-in-progress-CMB-RCTL =
    You are a CMB Riot Control Team Leader!
...
rmc-job-greeting-shivas-panic-room-researcher =
    You are a Weston-Yamada Scientist on the Colony!
...
rmc-job-greeting-shivas-panic-room-engineer =
    You are an Engineer on the Colony!
