ent-CMBeltSecurity = M276 pattern security rig
    .desc = The M276 is the standard load-bearing equipment of the USCM. It consists of a modular belt with various clips. This configuration is commonly seen among Marine Military Police and peacekeepers, though it can hold some light munitions.
...
ent-CMBeltSecurityMarshal = law enforcement duty belt
    .desc = The black duty belt used to carry the instruments of a law enforcement officer. It is a heavy police belt with several pouches to contain various law enforcement items.
