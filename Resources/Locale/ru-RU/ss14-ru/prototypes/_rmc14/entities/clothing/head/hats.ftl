...
ent-CMHeadBeretCMP = USCM Chief MP beret
    .desc = A beret with the USCM Military Police insignia emblazoned on it. It shines with the glow of corrupt authority and a smudge of doughnut.
...
ent-RMCHeadBeretGreen = USCM beret
    .suffix = Green
    .desc = { ent-CMHeadBeret.desc }
...
ent-CMHeadCapOfficer = USCM officer cap
...
ent-CMHeadFlapCap = USCM expedition cap
...
ent-RMCHeadBeretSquadIntel = { ent-RMCHeadBeretSquadAlpha }
    ...
    .suffix = Intel
ent-RMCProvostCommandBeret = USCM provost command beret
...
ent-RMCHeadWeYaPilotCap = Weyland-Yutani Pilot cap
