...
ent-RMCHeadBeretProvost = USCM provost beret
    .desc = A beret with the USCMC Military Police insignia emblazoned on it.
ent-RMCHeadBeretProvostSenior = USCM senior provost beret
...
ent-RMCHeadCapQuartermaster = USCM quartermaster cap
    .desc = It's a fancy hat for a not-so-fancy military supply clerk.
ent-RMCHeadBeretQuartermaster = USCM quartermaster beret
    .desc = A beret with the sergeant insignia emblazoned on it. It symbolizes hard work and shady business.
ent-RMCHeadUNMCHeadset = headset
