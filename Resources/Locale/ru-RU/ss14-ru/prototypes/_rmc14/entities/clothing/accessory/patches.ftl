...
ent-RMCPatchFORECON = USCM Force Reconnaissance patch
    .desc = A fire-resistant shoulder patch, worn by the men and women of the UNS Hanyut, USCMC FORECON.
...
ent-RMCPatchWeYa = Weyland-Yutani patch
...
ent-RMCPatchSPP = UPP patch
    .desc = An old fire-resistant shoulder patch, worn by the men and women of the Union of Progressive Peoples Armed Vanguard.
ent-RMCPatchSPPVDV = UPP Airborne Reconnaissance patch
    .desc = A fire-resistant shoulder patch, worn by the men and women of the 173rd Airborne Reconnaissance Platoon.
ent-RMCPatchSPPNaval = UPP Naval Infantry patch
