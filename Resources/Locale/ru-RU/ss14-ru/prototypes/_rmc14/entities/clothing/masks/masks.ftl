...
ent-RMCMaskGasSPP = ShMB/4 gasmask
    .desc = The standard issue gasmask utilized by the UPP Vanguard Collective and many UPP civilian organizations.
...
ent-RMCMaskBalaclavaSPPCommando = UPP armored commando balaclava
