...
ent-AU14PouchGeneralLargeMilDoctorFill = { ent-RMCPouchGeneralLarge }
    .suffix = Military Doctor, Filled
    .desc = { ent-RMCPouchGeneralLarge.desc }
ent-AU14PouchFirstResponderFilledMilitaryDoctor = { ent-RMCPouchFirstResponderFill }
    .suffix = Military Doctor, Filled
    .desc = { ent-RMCPouchFirstResponderFill.desc }
ent-AU14PouchAutoinjectorFilledMilitaryDoctor = { ent-RMCPouchAutoinjector }
    .suffix = Military Doctor, Filled
