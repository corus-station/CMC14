...
ent-RMCVisorPilotYellow = MK30 yellow flight visor
    .desc = { ent-RMCVisorPilotBlack.desc }
ent-AU14VisorSquadRMC = { ent-RMCVisorSquad }
    .desc = An insertable visor HUD into a standard RMC helmet.
ent-AU14VisorSquadIntegratedRMC = { ent-RMCVisorSquadIntegrated }
    .desc = An insertable visor HUD into a standard RMC helmet.
ent-AU14VisorMedicalRMC = HBVS visor
...
ent-AU14VisorMedicalAdvancedIntegratedRMC = HBVS-A visor
    .desc = One of the few successful components from the otherwise disastrous Commando Upgrade Program ran in the mid 2170s, the head-mounted, biomonitor vision system comes as standard in all RMC helmets.
