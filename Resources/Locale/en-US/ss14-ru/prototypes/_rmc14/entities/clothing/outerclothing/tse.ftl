ent-RMCArmorVestTSEPA = NSPA armored vest
    .desc = An Neroid Sector Policing Authority armored vest that protects against some damage.
ent-RMCBaseTSEArmor = { "" }
    .desc = { "" }
ent-RMCArmourM4TSEPA = M4 pattern light NSPA armour
    .desc = A modified variant of the M4R armor, stripped of additional riot plating for civilian officer use. A Neroid Sector Policing Authority badge is sewn into the chestplate.
ent-RMCArmourM4TSEPAChief = M4 pattern inspector NSPA armour
    .desc = A modified variant of the M4 Neroid Sector Policing Authority armour to have the additional riot plating returned, feauturing a golden insignia on the chestplate.
